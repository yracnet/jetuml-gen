...
public class GrouperFtr extends MapFilter implements Serializable {
	...
	@FilterElement
	private ValueFilter<String> grouperParentId;
	...
	public ValueFilter<String> getGrouperParentId() {
		return grouperParentId;
	}

	public void setGrouperParentId(ValueFilter<String> grouperParentId) {
		this.grouperParentId = grouperParentId;
	}
}
