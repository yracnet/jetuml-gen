...
import net.yracnet.old.ClassGenerator;

public class UtilityHelper {

  public static String removeDups(String stringInput) {
    String[] lines = stringInput.split(",");
    String[] unique = new LinkedHashSet<>(Arrays.asList(lines)).toArray(new String[0]);
  ...
  public static ArrayList<CompilationUnit> getCuArray(String in) throws Exception {
    ...
    File[] javaList = folder.listFiles(JAVA_FILTER);
    for (File f : javaList) {
  ...
  public static FilenameFilter JAVA_FILTER = (File dir, String name) -> name.endsWith(".java");
