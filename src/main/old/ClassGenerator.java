...
public class ClassGenerator {
  ...
  public static HashMap<String, String> mapRelationship;
  public static String astree;
  public static List<String> getterandsettermemberlist = new ArrayList<String>();

  public ClassGenerator(String sourceCodePath, String classDiagPath) {
    astree = "";
